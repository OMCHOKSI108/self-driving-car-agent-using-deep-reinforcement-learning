    ...
    def step(self, action_idx):
        try:
            ...
            if len(self.collision_history) != 0:
                ...
                reward = -50  # Increased from -10 for more crash defensiveness
            ...
            # Interpolated from 1 when aligned with the road to 0 when +/- 30 degrees of road (increased tolerance for turns)
